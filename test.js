...
test('hex-grid', function (t) {
  ...
  fs.writeFileSync(path.join(__dirname, '/fixtures/out/grid1.geojson'), JSON.stringify(grid1, null, 2));
  fs.writeFileSync(path.join(__dirname, '/fixtures/out/grid2.geojson'), JSON.stringify(grid2, null, 2));
  fs.writeFileSync(path.join(__dirname, '/fixtures/out/grid3.geojson'), JSON.stringify(grid3, null, 2));
  fs.writeFileSync(path.join(__dirname, '/fixtures/out/grid4.geojson'), JSON.stringify(grid4, null, 2));
